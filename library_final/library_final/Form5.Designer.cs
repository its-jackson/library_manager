namespace library_final
{
    partial class Form5
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Instructions: Enter the current email address of the member to delete.";
            // 
            // textBox1
            // 
            ...
            this.label2.Text = "Confirm the email address of the member to delete.";
